...
func LoginService(db *gorm.DB, cfg *common.Config, payload *LoginRequest, ip string, logger *logger.Logger) (*jwt.JWTPair, *database.User, *api.ApiError) {
